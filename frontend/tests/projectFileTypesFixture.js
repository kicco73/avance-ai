export const PROJECT_FILE_TYPES_PAYLOAD = {
  ...
  types: [
    ...
    { extension: '.png', content_type: 'image/png', label: 'PNG image', kind: 'image', folder: 'media', text: false, max_upload_bytes: 5 * 1024 * 1024 },
    { extension: '.svg', content_type: 'image/svg+xml', label: 'SVG image', kind: 'image', folder: 'media', text: false, max_upload_bytes: 5 * 1024 * 1024 },
    { extension: '.mp3', content_type: 'audio/mpeg', label: 'MP3 audio', kind: 'audio', folder: 'media', text: false, max_upload_bytes: 15 * 1024 * 1024 },
  ],
  media_folder: 'media',
  media_extensions: ['.gif', '.jpeg', '.jpg', '.mp3', '.pdf', '.png', '.svg', '.webp'],
}
