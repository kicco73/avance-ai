...
// is routed by the stream_id that frame minted — the only correlation there
...
describe('sendMessage over the chat websocket', () => {
  ...
  it('sends one turn frame carrying the session and text, and resolves on the done frame with that stream_id', async () => {
