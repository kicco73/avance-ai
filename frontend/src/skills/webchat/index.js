...
import { getCurrentSession, postCreateSession, postAction, getOperatorState, getMessages } from './api.js'
...
export const liveChatChannels = [{ getCurrentSession, createSession: postCreateSession, postAction, getOperatorState, getMessages }]
