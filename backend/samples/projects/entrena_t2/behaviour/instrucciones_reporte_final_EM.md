# REPORTE FINAL DE SESIÓN · EM ·

Términos: diccionario\_EM.txt (Compañerismo → Colaboración).
...
- Contadores profesional: PA PC RS RC AF RES BC EA INF+ ESC PER CONF DIR EPR PARS\_post\_DC IGN\_post\_DC
