...
from .models import (
    Archive, BenchmarkRun, BenchmarkRunObservation, ChatSession, History, Job, Message, Project, Settings,
    SessionSummary, StateRemap, Tracking, database,
)
...
class Db(
    ...
    _MODELS = (
        ...
        BenchmarkRun, BenchmarkRunObservation, SessionSummary,
    )
