"""GET /api/skills/platform/projects/{project_id}/graph (ProjectService.get_project_graph). Includes
...
def test_task_is_reported_per_edge_not_per_node(client):
    ...
    graph = client.get(f"/api/skills/platform/projects/{project_id}/graph").json()
