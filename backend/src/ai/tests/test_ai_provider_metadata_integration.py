...
from ai.turn.prompt import AudioPrompt, MemoryPrompt, Prompt, SignalsPrompt, TextPrompt
from ai.turn.turn_protocol_using_schema import TurnProtocolUsingSchema
from config import AppConfig, ConfigError

try:
    _APP_CONFIG = AppConfig()
    _AI_SERVICES = ai_config.parse(_APP_CONFIG.raw, _APP_CONFIG.path)
...
pytestmark = pytest.mark.skipif(
    _APP_CONFIG is None or not _AI_SERVICES,
    reason=(
