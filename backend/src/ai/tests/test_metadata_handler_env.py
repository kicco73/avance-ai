...
@pytest.mark.parametrize(("raw", "expected_turns", "mentions"), [
	...
	("turn,mood,engagement,focus\n1,50.2,70,1\n2,52,68,1\n[eof]", 2, "requested signals"),
	("mood,engagement\n1,50.2,70\n2,52,68\n[eof]", 2, "is not 'turn'"),
], ids=["missing-row", "non-numeric-row", "no-eof", "short-row", "long-row", "missing-signal", "unknown-signal", "no-turn-column"])
