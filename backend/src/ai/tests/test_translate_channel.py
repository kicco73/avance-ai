...
skips or mistranslates into a non-string must fall back to its own
original text rather than raise or leave a gap: an untranslated label
beats a missing one, and this is a UX nicety layered on top of an otherwise-complete reply, never core protocol
...
from ai.turn.prompt import TranslatePrompt
