"""Integration tests for POST /api/skills/testing/projects/{project_name}/runs/states/{state_key},
...
def test_state_test_ignores_an_unlabeled_sessions_leftover_annotation(client, hello_project):
    ...
    assert client.get(f"/api/skills/testing/projects/{hello_project}/tests?session_id={session_id}").json() == []
